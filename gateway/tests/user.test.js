  ...
  describe('Local ip', () => {
    ...
    describe(`Creates a user`, () => {
      test.each`
        ...
        ${'undefined of all'}                   | ${undefined}        | ${undefined}                         | ${undefined}    | ${undefined}   | ${undefined} | ${undefined} | ${undefined} | ${undefined}
        ${'null of all'}                        | ${''}               | ${''}                                | ${''}           | ${''}          | ${''}        | ${''}        | ${''}        | ${''}
        ${'whitespaces of all'}                 | ${'  '}             | ${'  '}                              | ${'  '}         | ${'  '}        | ${'  '}      | ${'  '}      | ${'  '}      | ${'  '}
      ...
      test.each`
        ...
        ${'invalid email: lacking of domain'}           | ${'elbertsoftware'} | ${'elbertsoftware.tester@gmail'}                                                  | ${undefined}           | ${'!dcba4321'} | ${'A?'}   | ${'a'}  | ${'B?'}   | ${'b'}
        ${'invalid email: lacking of domain'}           | ${'elbertsoftware'} | ${'elbertsoftware.tester@'}                                                       | ${undefined}           | ${'!dcba4321'} | ${'A?'}   | ${'a'}  | ${'B?'}   | ${'b'}
        ${'invalid email: lacking of @ domain'}         | ${'elbertsoftware'} | ${'elbertsoftware.tester'}                                                        | ${undefined}           | ${'!dcba4321'} | ${'A?'}   | ${'a'}  | ${'B?'}   | ${'b'}
        ${'invalid email: lacking of @ domain'}         | ${'elbertsoftware'} | ${'elbertsoftware'}                                                               | ${undefined}           | ${'!dcba4321'} | ${'A?'}   | ${'a'}  | ${'B?'}   | ${'b'}
        ${'invalid email: lacking of mailbox'}          | ${'elbertsoftware'} | ${'@gmail.com.io'}                                                                | ${undefined}           | ${'!dcba4321'} | ${'A?'}   | ${'a'}  | ${'B?'}   | ${'b'}
        ${'invalid email: lacking of mailbox'}          | ${'elbertsoftware'} | ${'@gmail.com'}                                                                   | ${undefined}           | ${'!dcba4321'} | ${'A?'}   | ${'a'}  | ${'B?'}   | ${'b'}
        ${'invalid email: lacking of mailbox & domain'} | ${'elbertsoftware'} | ${'@gmail'}                                                                       | ${undefined}           | ${'!dcba4321'} | ${'A?'}   | ${'a'}  | ${'B?'}   | ${'b'}
    ...
    describe('Login', () => {
      ...
      test.each`
        ...
        ${'by email but pwd is whitespaces'}   | ${'john@example.com'}   | ${undefined}     | ${'  '}
        ...
        ${'by phone but phone is whitespaces'} | ${undefined}            | ${'  '}          | ${'!abcd1234'}
    ...
    describe('Fetch profile', () => {
      test("Should fetch logged-in user's profile", async () => {
        ...
        expect(data.me.phone).toBe(seedUserOne.user.phone); // with authentication, phone is showed
    ...
    describe(`Log out`, () => {
      ...
      test('Should log out after logged in', async () => {
        ...
        expect(data.logout.token).toBe(token);
      ...
      // TODO: move this test to ngrok section
      test('Should log out all after logged in', async () => {
        // and then logs out all
        const graphQLClientWithToken = getGraphQLClient(token);
        const logout = gql`
          mutation {
            logout(all: true) {
      ...
      // TODO: move this test to ngrok token
...
describe(`Testing with ngrok: real ip`, async () => {
